...
static int do_chan_configs(void)
{
    ...
    m.cmd.DacTrigger = 0;
    g = 0;
    m.cmd.Gate[g].GateType = DBPOD_GATETYPE_AVERAGING;
    m.cmd.Gate[g].Reference = DBPOD_GATEREF_ABSOLUTE;
    m.cmd.Gate[g].nThreshold = 0;
    m.cmd.Gate[g].lStart = 0;
    m.cmd.Gate[g].lWidth = 1000;
    m.cmd.Gate[g].nControl = 0;
    m.cmd.Gate[g].lParameter = 0;
    g++;
#if 0
    m.cmd.Gate[g].GateType = DBPOD_GATETYPE_RECORD;
    m.cmd.Gate[g].Reference = DBPOD_GATEREF_ABSOLUTE;
    m.cmd.Gate[g].nThreshold = 0;
    m.cmd.Gate[g].lStart = 0;
    m.cmd.Gate[g].lWidth = 1000;
...
#endif
#if 1
    m.cmd.Gate[g].GateType = DBPOD_GATETYPE_PEAK;
    m.cmd.Gate[g].Reference = DBPOD_GATEREF_ABSOLUTE;
    m.cmd.Gate[g].nThreshold = 100;
    m.cmd.Gate[g].lStart = 1000;
    m.cmd.Gate[g].lWidth = 2000;
    m.cmd.Gate[g].nControl = 0;
    m.cmd.Gate[g].lParameter = 0;
    g++;
#endif
