...
static int do_chan_configs(void)
{
    ...
    m.cmd.Gate[0].nThreshold = 100;
    m.cmd.Gate[0].lStart = 0;
    //m.cmd.Gate[0].lWidth = 1884;
    m.cmd.Gate[0].lWidth = 8200;
    m.cmd.Gate[0].nControl = 0;
    m.cmd.Gate[0].lParameter = 256;
    m.cmd.Gate[1].GateType = DBPOD_GATETYPE_RECORD;
    m.cmd.Gate[1].Reference = DBPOD_GATEREF_ABSOLUTE;
    m.cmd.Gate[1].nThreshold = 100;
    m.cmd.Gate[1].lStart = 0;
    //m.cmd.Gate[2].lWidth = 1000;
    m.cmd.Gate[1].lWidth = m.cmd.Gate[0].lWidth;
    m.cmd.Gate[1].nControl = 0;
    m.cmd.Gate[1].lParameter = 0;
    m.cmd.Gate[2].GateType = DBPOD_GATETYPE_INTERFACE;
    m.cmd.Gate[2].Reference = DBPOD_GATEREF_ABSOLUTE;
    m.cmd.Gate[2].nThreshold = 750;
    m.cmd.Gate[2].lStart = 400;
    m.cmd.Gate[2].lWidth = 1000;
    m.cmd.Gate[2].nControl = 1;
    m.cmd.Gate[2].lParameter = 700;
